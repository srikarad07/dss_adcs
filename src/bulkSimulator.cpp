...
void executeBulkSimulator( const rapidjson::Document& config )
{
            ...
            ++ numberOfReactionWheels )
    {
        ...
        {
            metadatafile << "ConceptIdentifier,reactionWheelName1,reactionWheelName2,reactionWheelName3,reactionWheelName4,principleInertia1,principleInertia2,principleInertia3,InitialAttitudeState1,InitialAttitudeState2,InitialAttitudeState3,InitialAttitudeState4,InitialAttitudeState5,InitialAttitudeState6,InitialAttitudeState7,AttitudeReferenceState1,AttitudeReferenceState2,AttitudeReferenceState3,AttitudeReferenceState4,AsymmetricBodyTorqueFlag,GravityGradientBodyFlag,ControlTorqueFlag,GravitationalParameter,NaturalFrequency,DampingRatio,SlewRate,SemiMajorAxis,ControllerType,Radius,Integrator,StartEpoch,EndEpoch,TimeStep,RelativeTolerance,AbsoluteTolerance,rw1Uuid,rw2UUid,rw3UUid,rw4UUid,rw1WheelOrientation1,rw2WheelOrientation1,rw3WheelOrientation1,rw4WheelOrientation1,rw1WheelOrientation2,rw2WheelOrientation2,rw3WheelOrientation2,rw4WheelOrientation2,reactionWheelMass1,reactionWheelMass2,reactionWheelMass3,reactionWheelMass4,reactionWheelTorque1,reactionWheelTorque2,reactionWheelTorque3,reactionWheelTorque4" << std::endl;
        ...
        {
            metadatafile << "ConceptIdentifier,reactionWheelName1,reactionWheelName2,reactionWheelName3,reactionWheelName4,reactionWheelName5,principleInertia1,principleInertia2,principleInertia3,InitialAttitudeState1,InitialAttitudeState2,InitialAttitudeState3,InitialAttitudeState4,InitialAttitudeState5,InitialAttitudeState6,InitialAttitudeState7,AttitudeReferenceState1,AttitudeReferenceState2,AttitudeReferenceState3,AttitudeReferenceState4,AsymmetricBodyTorqueFlag,GravityGradientBodyFlag,ControlTorqueFlag,GravitationalParameter,NaturalFrequency,DampingRatio,SlewRate,SemiMajorAxis,ControllerType,Radius,Integrator,StartEpoch,EndEpoch,TimeStep,RelativeTolerance,AbsoluteTolerance,rw1Uuid,rw2UUid,rw3UUid,rw4UUid,rw5UUid,rw1WheelOrientation1,rw2WheelOrientation1,rw3WheelOrientation1,rw4WheelOrientation1,rw5WheelOrientation1,rw1WheelOrientation2,rw2WheelOrientation2,rw3WheelOrientation2,rw4WheelOrientation2,rw5WheelOrientation2,reactionWheelMass1,reactionWheelMass2,reactionWheelMass3,reactionWheelMass4,reactionWheelMass5,reactionWheelTorque1,reactionWheelTorque2,reactionWheelTorque3,reactionWheelTorque4,reactionWheelTorque5" << std::endl;
        ...
        {
            metadatafile << "ConceptIdentifier,reactionWheelName1,reactionWheelName2,reactionWheelName3,reactionWheelName4,reactionWheelName5,reactionWheelName6,principleInertia1,principleInertia2,principleInertia3,InitialAttitudeState1,InitialAttitudeState2,InitialAttitudeState3,InitialAttitudeState4,InitialAttitudeState5,InitialAttitudeState6,InitialAttitudeState7,AttitudeReferenceState1,AttitudeReferenceState2,AttitudeReferenceState3,AttitudeReferenceState4,AsymmetricBodyTorqueFlag,GravityGradientBodyFlag,ControlTorqueFlag,GravitationalParameter,NaturalFrequency,DampingRatio,SlewRate,SemiMajorAxis,ControllerType,Radius,Integrator,StartEpoch,EndEpoch,TimeStep,RelativeTolerance,AbsoluteTolerance,rw1Uuid,rw2UUid,rw3UUid,rw4UUid,rw5UUid,rw6UUid,rw1WheelOrientation1,rw2WheelOrientation1,rw3WheelOrientation1,rw4WheelOrientation1,rw5WheelOrientation1,rw6WheelOrientation1,rw1WheelOrientation2,rw2WheelOrientation2,rw3WheelOrientation2,rw4WheelOrientation2,rw5WheelOrientation2,rw6WheelOrientation2,reactionWheelMass1,reactionWheelMass2,reactionWheelMass3,reactionWheelMass4,reactionWheelMass5,reactionWheelMass6,reactionWheelTorque1,reactionWheelTorque2,reactionWheelTorque3,reactionWheelTorque4,reactionWheelTorque5,reactionWheelTorque6" << std::endl;
                                        ...
                                        ++reactionWheelConceptIterator )
    {
                ...
                ++numberOfSimulation )
        {
            ...
            VectorXd reactionWheelMass( reactionWheelConcept.size() );
            VectorXd reactionWheelTorque( reactionWheelConcept.size() );
                        ...
                        conceptIterator != reactionWheelConcept.end(); ++conceptIterator )
            {
               ...
               reactionWheelMass[iterationLoop]             = tempReactionWheel.mass;
               reactionWheelTorque[iterationLoop]           = tempReactionWheel.maxTorque;
               iterationLoop += 1;  
            }
            ...
            doPrint( metadatafile, conceptIdentifierMonteCarlo, reactionWheelNames, principleInertia, input.initialAttitudeState, 
             ...
             reactionWheelMass, reactionWheelTorque  );  
