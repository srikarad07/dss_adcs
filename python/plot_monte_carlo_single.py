...
for filename in range(len(filesForTheplots)):
    ...
    pass
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/attitudes.eps')
plt.close()
...
for filename in range(len(filesForTheplots)):
    ...
    pass
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/controlTorques.eps')
plt.close()
...
for filename in range(len(filesForTheplots)):
    ...
    pass 
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/motorTorques.eps')
plt.close()
...
for filename in range(len(filesForTheplots)):
    ...
    plt.tight_layout()
    pass 
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/angularMomentumReactionWheels.eps')
plt.close()
...
for filename in range(len(filesForTheplots)):
    ...
    plt.grid()
    pass 
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/reactionWheelAngularRates.eps')
plt.close()
...
for filename in range(len(filesForTheplots)):
    ...
    plt.grid()
    pass 
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/power.eps')
plt.close()
...
for filename in range(len(filesForTheplots)):
    ...
    plt.grid()
    pass 
fig.savefig('/home/superman/Delft/Thesis/thesis-report/Images/results/monte_carlo/angularRatesSpacecraft.eps')
plt.close()
