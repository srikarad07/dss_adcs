...
# ax1.plot(state_history['t']/60.0, state_history['theta1'], color='k')
# ax1.set_xlabel('time[min]')
# ax1.set_ylabel('theta_1 [deg]')
# ax1.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
# ax1.grid()

# ax2.plot(state_history['t']/60.0, state_history['theta2'], color='k')
# ax2.set_xlabel('time[min]')
# ax2.set_ylabel('theta_2 [deg]')
# ax2.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
# ax2.grid()

# ax3.plot(state_history['t']/60.0, state_history['theta3'], color='k')
# ax3.set_xlabel('time[min]')
...
#Plot angular velocity with respect to time. 
ax1.plot(state_history['t']/60.0, state_history['motorTorque1'], color='k')
ax1.set_xlabel('time[min]')
ax1.set_ylabel('Motor torque_X [N/m]')
ax1.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax1.grid()

ax2.plot(state_history['t']/60.0, state_history['motorTorque2'], color='k')
ax2.set_xlabel('time[min]')
ax2.set_ylabel('Motor torque_X [N/m]')
ax2.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax2.grid()

ax3.plot(state_history['t']/60.0, state_history['motorTorque3'], color='k')
ax3.set_xlabel('time[min]')
...
#Plot angular velocity with respect to time. 
ax1.plot(state_history['t']/60.0, state_history['angularMomentum1'], color='k')
ax1.set_xlabel('time[min]')
ax1.set_ylabel('Angular momentum [kgm2/sec]')
ax1.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax1.grid()

ax2.plot(state_history['t']/60.0, state_history['angularMomentum2'], color='k')
ax2.set_xlabel('time[min]')
ax2.set_ylabel('Angular momentum [kgm2/sec]')
ax2.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax2.grid()

ax3.plot(state_history['t']/60.0, state_history['angularMomentum3'], color='k')
ax3.set_xlabel('time[min]')
...
#Plot angular velocity with respect to time. 
ax1.plot(state_history['t']/60.0, state_history['reactionWheelAngularVelocity1'], color='k')
ax1.set_xlabel('time[min]')
ax1.set_ylabel('Angular Velocity [rad/sec]')
ax1.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax1.grid()

ax2.plot(state_history['t']/60.0, state_history['reactionWheelAngularVelocity2'], color='k')
ax2.set_xlabel('time[min]')
ax2.set_ylabel('Angular Velocity [rad/sec]')
ax2.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax2.grid()

ax3.plot(state_history['t']/60.0, state_history['reactionWheelAngularVelocity3'], color='k')
ax3.set_xlabel('time[min]')
...
#Plot angular velocity with respect to time. 
ax1.plot(state_history['t']/60.0, state_history['powerConsumption1'], color='k')
ax1.set_xlabel('time[min]')
ax1.set_ylabel('Power Consumption [W]')
ax1.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax1.grid()

ax2.plot(state_history['t']/60.0, state_history['powerConsumption2'], color='k')
ax2.set_xlabel('time[min]')
ax2.set_ylabel('Power Consumption [W]')
ax2.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax2.grid()

ax3.plot(state_history['t']/60.0, state_history['powerConsumption3'], color='k')
ax3.set_xlabel('time[min]')
...
#Plot angular velocity with respect to time. 
ax1.plot(state_history['t']/60.0, state_history['disturbanceTorque1'], color='k')
ax1.set_xlabel('time[min]')
ax1.set_ylabel('T_dx')
ax1.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax1.grid()

ax2.plot(state_history['t']/60.0, state_history['disturbanceTorque2'], color='k')
ax2.set_xlabel('time[min]')
ax2.set_ylabel('T_Dy')
ax2.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax2.grid()

ax3.plot(state_history['t']/60.0, state_history['disturbanceTorque3'], color='k')
ax3.set_xlabel('time[min]')
ax3.set_ylabel('T_Dz')
ax3.ticklabel_format(style='plain', axis='both', scilimits=(0,0))
ax3.grid()
